...
const TRENDING_TOPICS = [
  { topic: "#ReactNative", posts: "125K" },
  { topic: "#TypeScript", posts: "89K" },
  { topic: "#WebDevelopment", posts: "234K" },
  { topic: "#AI", posts: "567K" },
  { topic: "#TechNews", posts: "98K" },
];
    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="px-4 py-3 border-b border-gray-100">
        <View className="flex-row items-center bg-gray-100 rounded-full px-4 py-3">
          ...
          <TextInput placeholder="Search VYou" className="flex-1 ml-3 text-base" placeholderTextColor="#657786" />
        </View>
      </View>
        ...
        <View className="p-4">
          ...
          {TRENDING_TOPICS.map((item, index) => (
            <TouchableOpacity key={index} className="py-3 border-b border-gray-100">
              ...
              <Text className="text-gray-500 text-sm">{item.posts} Posts</Text>
            </TouchableOpacity>
          ))}
        </View>
      </ScrollView>
