      ...
      {selectedPost && (
        <ScrollView className="flex-1">
          ...
          <View className="border-b border-gray-100 bg-white p-4">
            <View className="flex-row">
              ...
              <View className="flex-1">
                ...
                {selectedPost.content && <Text className="text-gray-900 text-base leading-5 mb-3">{selectedPost.content}</Text>}

                {selectedPost.image && <Image source={{ uri: selectedPost.image }} className="w-full h-48 rounded-2xl mb-3" resizeMode="cover" />}
              </View>
            </View>
          </View>
          ...
          <View className="p-4 border-t border-gray-100">
            <View className="flex-row">
              <Image source={{ uri: currentUser?.profilePicture }} className="size-10 rounded-full mr-3" />
