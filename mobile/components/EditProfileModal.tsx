  ...
  return (
    <Modal visible={isVisible} animationType="slide" presentationStyle="pageSheet">
      <View className="flex-row items-center justify-between px-4 py-3 border-b border-gray-100">
        ...
        <TouchableOpacity onPress={handleSave} disabled={isUpdating} className={`${isUpdating ? "opacity-50" : ""}`}>
          {isUpdating ? <ActivityIndicator size="small" color="#1DA1F2" /> : <Text className="text-blue-500 text-lg font-semibold">Save</Text>}
        </TouchableOpacity>
      </View>
